...
class EvaluatorBuilder1 {
    public static Evaluator build(Evaluator.TYPE type) throws InvalidEvaluation {
        ...
        {
            return applicant -> applicant.getEmploymentYears() > 10 && !applicant.hasCriminalRecord();
        }else if(type == Evaluator.TYPE.MORE_EXPERIENCE_AND_MORE_CREDIT_SCORE)
        {
            return applicant -> applicant.getCreditScore() > 500 && applicant.getEmploymentYears() > 10;
        }else {
