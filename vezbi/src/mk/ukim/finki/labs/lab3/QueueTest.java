...
class Queue<T>{
    ...
    public T dequeue() throws EmptyQueueException {
        if(isEmpty()) throw new EmptyQueueException("Redot e prazen!");

        T element = front.getElement();
        front = front.getNext(); // го поместува на следниот, првиот се отстранува бидејќи front не покажува на него
    ...
    public T inspect() throws EmptyQueueException {if(isEmpty()) throw new EmptyQueueException("Redot e prazen!");
